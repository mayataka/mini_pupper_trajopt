#include "mini_pupper_trotting_controller.hpp"
...
MiniPupperTrottingController::MiniPupperTrottingController()
  : joint_handlers_(),
    q_cmd_() {
...
bool MiniPupperTrottingController::init(
...
void MiniPupperTrottingController::starting(const ros::Time& time) {
}


void MiniPupperTrottingController::stopping(const ros::Time& time) {
}


void MiniPupperTrottingController::update(const ros::Time& time, 
...
PLUGINLIB_EXPORT_CLASS(mini_pupper_trajopt::MiniPupperTrottingController, 
