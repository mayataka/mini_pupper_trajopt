#include "mini_pupper_running_controller.hpp"
...
MiniPupperRunningController::MiniPupperRunningController()
  : joint_handlers_(),
    q_cmd_() {
...
bool MiniPupperRunningController::init(
...
void MiniPupperRunningController::starting(const ros::Time& time) {
}


void MiniPupperRunningController::stopping(const ros::Time& time) {
}


void MiniPupperRunningController::update(const ros::Time& time, 
...
PLUGINLIB_EXPORT_CLASS(mini_pupper_trajopt::MiniPupperRunningController, 
