...
mini_pupper_trajopt.logger.take_log(vars=vs, file_name='v', root_dir='rsc/bounding')
mini_pupper_trajopt.logger.take_log(vars=us, file_name='u', root_dir='rsc/bounding')
...
mini_pupper_trajopt.logger.take_log(vars=v_initial_cycle, file_name='v_initial_cycle', root_dir='rsc/bounding')
...
mini_pupper_trajopt.logger.take_log(vars=v_cycle, file_name='v_cycle', root_dir='rsc/bounding')