...
base.lf.upper_leg.setOrigin(-4e-05, 0.0197, -0.0, 0.0, 0.0, 0.0);
base.lf.lower_leg.setOrigin(0.0, 0.00475, -0.05, 0.0, 0.0, 0.0);
     base.lf.foot.setOrigin(0.0, -4.99999999999e-05, -0.056, 0.0, 0.0, 0.0);

      base.rf.hip.setOrigin(0.06014, -0.0235, 0.0171, 0.0, 0.0, 0.0);
base.rf.upper_leg.setOrigin(-4e-05, -0.0197, -0.0, 0.0, 0.0, 0.0);
...
base.lh.upper_leg.setOrigin(-4e-05, 0.0197, -0.0, 0.0, 0.0, 0.0);
...
base.rh.upper_leg.setOrigin(-4e-05, -0.0197, -0.0, 0.0, 0.0, 0.0);
